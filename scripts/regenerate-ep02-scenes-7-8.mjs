#!/usr/bin/env node
// scripts/regenerate-ep02-scenes-7-8.mjs — Regenerate Scene 7 & 8 with updated dialogues
...
const scenes = [
  {
    ...
    dialogue: '[excited] Ponga ponga... seekiram ponga.',
  ...
  },
  {
    ...
    dialogue: '[excited] Paaru, Kaavya akka... [sighs with awe] romba super-ah irukku. [thoughtful] Yarayum adachi vekka-vey kudaathu',
    filename: 'ep02-s08-meenu-awe.mp3'
  }
];

console.log('🎙️  EP02 Scenes 7-8 Regeneration\n');
